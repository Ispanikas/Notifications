<?php
// Retrieve GET parameters directly (no security like htmlspecialchars)
$url = $_GET['url'] ?? '';
...
<body>
    <div class="container">
        ...
        <form id="continue_action" method="GET" action="https://gateway.zscalerbeta.net:443/_sm_ctn">
                <!-- Echo GET values directly without htmlspecialchars -->
                <input type="hidden" name="_sm_url" value="<?php echo $url; ?>">
                <input type="hidden" name="_sm_rid" value="<?php echo implode('zsq', $zsq); ?>">
