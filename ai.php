...
<head>
    ...
    <title>Access Restricted &ndash; AI Services</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Access Restricted &ndash; AI Services</h1>
        ...
        <ul>
            ...
            <li><strong>Always Label the Source of Data:</strong> If AI assisted your work, disclose it (e.g., &ldquo;generated by use of ChatGPT&rdquo;).</li>
        ...
        <div class="useful-links">
            ...
            <p class="note">If you can&rsquo;t access Corporate Copilot, contact your IT Service Desk.</p>
        </div>
