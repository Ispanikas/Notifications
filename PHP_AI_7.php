...
<body>
    <div class="container">
        ...
        <!-- If your cloud uses a different host, update gateway.zscalerbeta.net below -->
        <form id="continue_action" method="GET" action="https://gateway.zscalerbeta.net:443/_sm_ctn">
            ...
            <input type="hidden" name="_sm_rid" value="<?php echo $e($rid); ?>"> <!-- Ensure this is passed correctly -->
            <input type="hidden" name="_sm_cat" value="<?php echo $e($cat); ?>">
            <input type="hidden" name="_sm_lang" value="<?php echo $e($lang); ?>"> <!-- Include language if needed -->
            <input type="hidden" name="_orig_url" value="<?php echo $e($url); ?>"> <!-- Ensure _orig_url is passed -->
