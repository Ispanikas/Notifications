...
// Fixed approved destination for this block page
$REDIRECT_URL = 'https://filecheck.zscaler.com/';
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Access Restricted &ndash; Sandbox URL</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h1>Access Restricted &ndash; Sandbox URL</h1>
        <p>You&rsquo;re attempting to use a third-party file sandboxing or checking service that is not permitted. To ensure consistent security controls and privacy protection, please use our approved Zscaler FileCheck service.</p>
        <p class="note">You&rsquo;ll be redirected automatically in 60 seconds.</p>
        ...
        <div class="callout">
            ...
            <br>
            <a href="https://help.zscaler.com/zia/using-sandbox-scanning-portal" target="_blank" rel="noopener">Using the Sandbox Scanning Portal &ndash; ZIA Help</a>
        </div>
